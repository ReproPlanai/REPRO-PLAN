...
- ADMIN
  - Phone number: `+233-24-000-0001`
  - Email: `admin@test.reproplan`
  - Alternate: `+233-24-000-0006` / `ops.admin@test.reproplan`
- POLICE
  - Phone number: `+233-24-000-0002`
  - Email: `police@test.reproplan`
  - Alternate: `+233-24-000-0007` / `supervisor.police@test.reproplan`
- SAFEHOUSE
  - Phone number: `+233-24-000-0003`
  - Email: `safehouse@test.reproplan`
  - Alternate: `+233-24-000-0008` / `manager.safehouse@test.reproplan`
- MEDICAL
  - Phone number: `+233-24-000-0004`
  - Email: `medical@test.reproplan`
  - Alternate: `+233-24-000-0009` / `clinic.supervisor@test.reproplan`
- NGO
  - Phone number: `+233-24-000-0005`
  - Email: `ngo@test.reproplan`
  - Alternate: `+233-24-000-0010` / `outreach.ngo@test.reproplan`
