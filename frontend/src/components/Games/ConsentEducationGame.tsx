    ...
    return (
      ...
      >
        <main className="px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
          {/* Hero */}
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-pink-600 via-rose-600 to-purple-600 p-6 sm:p-8 shadow-2xl shadow-pink-500/20 mb-6">
            ...
            <div className="relative flex items-start gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <h1 className="text-xl sm:text-2xl font-bold text-white mb-2">Consent Game</h1>
                <p className="text-sm text-white/90 leading-relaxed">
                  Learn about consent, boundaries, and healthy relationships through AI-generated scenarios tailored for Ghana.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 mb-6">
            {[
              { icon: Brain, title: 'AI-Powered', desc: 'Scenarios', color: 'from-blue-500 to-cyan-500' },
              ...
              return (
                <div key={feature.desc} className="flex items-center gap-3 p-3 sm:p-4 rounded-2xl bg-white/80 backdrop-blur-sm border border-gray-200/60 shadow-sm">
          ...
          <div className="grid grid-cols-3 gap-3 sm:gap-4 mb-6">
            <div className="rounded-2xl bg-white/80 backdrop-blur-sm border border-gray-200/60 p-4 shadow-sm">
            ...
            <div className="rounded-2xl bg-white/90 backdrop-blur-sm border border-gray-200/80 p-6 shadow-sm mb-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {gameStats.achievements.map((achievementId) => {
                  ...
                  return (
                    <div key={achievementId} className="flex items-center gap-3 p-3 bg-yellow-50 rounded-xl border border-yellow-200">
                      <Icon className="w-6 h-6 text-yellow-600 flex-shrink-0" />
                      <div>
                        <h3 className="font-medium text-yellow-900 text-sm">{achievement.name}</h3>
          ...
          <button
            ...
            className="w-full py-3 px-8 bg-gradient-to-r from-pink-500 to-rose-500 text-white rounded-xl font-semibold hover:from-pink-600 hover:to-rose-600 disabled:opacity-70 flex items-center justify-center gap-2 transition-all shadow-lg"
          >
            {scenariosLoading ? (
  ...
  if (gameCompleted) {
    ...
    return (
      ...
      >
        <main className="px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
          {/* Hero */}
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-amber-500 via-yellow-500 to-orange-500 p-6 sm:p-8 shadow-2xl shadow-amber-500/20 mb-6">
            <div className="absolute inset-0 bg-[linear-gradient(135deg,transparent_40%,rgba(255,255,255,0.05)_100%)]" />
            <div className="relative flex items-start gap-4">
              <div className="flex-shrink-0 p-3 bg-white/20 backdrop-blur-sm rounded-2xl">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-1">
                  <span className="px-2.5 py-0.5 bg-white/25 rounded-full text-xs font-semibold text-white uppercase tracking-wide">Completed</span>
                  <Sparkles className="w-3.5 h-3.5 text-white/80" />
                </div>
                <h1 className="text-xl sm:text-2xl font-bold text-white mb-2">Game Completed!</h1>
                <p className="text-sm text-white/90 leading-relaxed">
                  Great job learning about consent and healthy relationships.
                </p>
              </div>
            </div>
          </div>
