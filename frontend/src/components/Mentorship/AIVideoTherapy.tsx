...
const THERAPY_TOPICS = [
  ...
  { id: 'communication', label: 'Communication Skills', icon: Heart, color: 'from-green-500 to-emerald-500' },
...
const AIVideoTherapy: React.FC = () => {
  ...
  return (
    <div className="space-y-6 sm:space-y-8">
      {/* Hero */}
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-primary-600 via-purple-600 to-pink-600 p-6 sm:p-8 shadow-2xl shadow-primary-500/20">
        ...
        {THERAPY_TOPICS.map((topic) => {
          ...
          return (
            <button
              ...
              className="bg-white rounded-2xl border border-gray-200/60 shadow-sm p-4 sm:p-6 hover:shadow-xl transition-all transform hover:-translate-y-1 group"
            >
              <div className={`inline-flex p-3 sm:p-4 rounded-2xl bg-gradient-to-br ${topic.color} mb-3 sm:mb-4 group-hover:scale-110 transition-transform`}>
                <Icon className="w-6 h-6 sm:w-8 sm:h-8 text-white" />
              </div>
              <h3 className="font-semibold text-gray-900 text-sm sm:text-base lg:text-lg mb-2">{topic.label}</h3>
      ...
      <div className="rounded-2xl bg-blue-50/80 border border-blue-200/60 p-4 sm:p-6">
        <div className="flex items-start gap-4">
          ...
          <div>
            <h4 className="font-semibold text-blue-900 text-base sm:text-lg mb-2">Your Safety Matters</h4>
