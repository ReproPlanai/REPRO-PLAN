      ...
      <main className="px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        ...
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-primary-600 via-purple-600 to-pink-600 p-6 sm:p-8 shadow-2xl shadow-primary-500/20 mb-6">
          ...
          <div className="relative flex items-start justify-between gap-4">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-1">
                  <span className="px-2.5 py-0.5 bg-white/25 rounded-full text-xs font-semibold text-white uppercase tracking-wide">Safe Spaces</span>
            ...
            <button onClick={() => setShowDiscreetMode(!showDiscreetMode)} className={`flex-shrink-0 p-2.5 rounded-xl ${showDiscreetMode ? 'bg-white/25' : 'bg-white/10'} transition-colors`} title={showDiscreetMode ? 'Exit discreet mode' : 'Enter discreet mode'}>
        ...
        {/* Ask ReproBot */}
        <div className="rounded-2xl bg-white/90 backdrop-blur-sm border border-gray-200/80 p-4 shadow-sm mb-6">
        ...
        {/* Emergency Contacts */}
        <div className="rounded-2xl bg-red-50/80 border border-red-200/60 p-4 sm:p-6 mb-6">
        ...
        <div className="space-y-4 mb-6 pb-20 sm:pb-8">
          {viewMode === 'map' ? (
        ...
        {/* Safety Tips */}
        <div className="rounded-2xl bg-blue-50/80 border border-blue-200/60 p-4 sm:p-6 mb-6">
