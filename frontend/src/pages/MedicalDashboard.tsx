        ...
        <div className="px-3 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-14 sm:h-16">
            <div className="flex items-center space-x-2 sm:space-x-3">
              <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-xl overflow-hidden flex items-center justify-center shadow-md ring-2 ring-purple-100 bg-gradient-to-br from-purple-500 to-pink-500">
                <img 
                  src={LogoCircular} 
                  alt="REPRO PLAN Logo" 
              ...
              <div className="min-w-0 flex-1 flex flex-col leading-[1]">
                <h1 className="text-base sm:text-lg font-bold text-gray-900 truncate">Medical Dashboard</h1>
                <p className="text-xs sm:text-sm text-gray-500 hidden sm:block -mt-2 leading-none">Patient Care & Medical Services</p>
              </div>
            </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-4 sm:mb-6">
                  <div className="bg-white p-4 sm:p-5 rounded-2xl shadow-sm border border-gray-200/60 hover:shadow-md transition-shadow">
                    <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                      <div className="min-w-0 flex-1">
                        <p className="text-xs text-gray-500 uppercase tracking-wider font-medium truncate">Total Patients</p>
                        <p className="text-xl sm:text-2xl font-bold text-gray-900 mt-1">{medicalData.medicalMetrics.totalPatients.toLocaleString()}</p>
                      </div>
                  ...
                  <div className="bg-white p-4 sm:p-5 rounded-2xl shadow-sm border border-gray-200/60 hover:shadow-md transition-shadow">
                    <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                      <div className="min-w-0 flex-1">
                        <p className="text-xs text-gray-500 uppercase tracking-wider font-medium truncate">Active Patients</p>
                        <p className="text-xl sm:text-2xl font-bold text-green-600 mt-1">{medicalData.medicalMetrics.activePatients.toLocaleString()}</p>
                      </div>
                  ...
                  <div className="bg-white p-4 sm:p-5 rounded-2xl shadow-sm border border-gray-200/60 hover:shadow-md transition-shadow">
                    <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                      <div className="min-w-0 flex-1">
                        <p className="text-xs text-gray-500 uppercase tracking-wider font-medium truncate">Appointments Today</p>
                        <p className="text-xl sm:text-2xl font-bold text-purple-600 mt-1">{medicalData.medicalMetrics.appointmentsToday}</p>
                      </div>
                  ...
                  <div className="bg-white p-4 sm:p-5 rounded-2xl shadow-sm border border-gray-200/60 hover:shadow-md transition-shadow">
                    <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                      <div className="min-w-0 flex-1">
                        <p className="text-xs text-gray-500 uppercase tracking-wider font-medium truncate">Emergency Cases</p>
                        <p className="text-xl sm:text-2xl font-bold text-red-600 mt-1">{medicalData.medicalMetrics.emergencyCases}</p>
                      </div>
